...
if _R.Circles then SWRP.Circles = _R.Circles return _R.Circles end -- SWRP: adapter on cached path too
...
--------------------------------------------------------------------------------
-- SWRP vendoring adapter (modification to upstream, MIT):
-- expose through the gamemode namespace instead of a require() return.
-- Upstream: https://github.com/SneakySquid/Circles
--------------------------------------------------------------------------------
SWRP.Circles = _R.Circles
